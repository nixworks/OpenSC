		...
		CK_ATTRIBUTE_PTR pPrivTpl, CK_ULONG ulPrivCnt)
{
	...
	if (pPrivTpl && ulPrivCnt)
		rv = attr_find_ptr2(pPubTpl, ulPubCnt, pPrivTpl, ulPrivCnt, CKA_GOSTR3410_PARAMS, &gost_params_encoded_oid_from_template, &len);
	else
		rv = attr_find_ptr(pPubTpl, ulPubCnt, CKA_GOSTR3410_PARAMS, &gost_params_encoded_oid_from_template, &len);
	...
	if (pPrivTpl && ulPrivCnt)
		rv = attr_find_ptr2(pPubTpl, ulPubCnt, pPrivTpl, ulPrivCnt, CKA_GOSTR3411_PARAMS, &gost_hash_params_encoded_oid_from_template, &len);
	else
		rv = attr_find_ptr(pPubTpl, ulPubCnt, CKA_GOSTR3411_PARAMS, &gost_hash_params_encoded_oid_from_template, &len);
